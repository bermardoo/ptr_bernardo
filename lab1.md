...
No primeiro momento, criamos o arquivo do laboratório no PNetLab e inserimos três nós, dois PC's (escolhi o VPC) e um switch L3 ou roteador (fui com o Cisco IOL). Abaixo está disponível uma imagem da topologia e a tabela de endereçamento.
